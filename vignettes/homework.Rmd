...
```{r}
gen_data <- function( n_seq, mu_seq, sigma, m){
  set.seed(123)
  dat <- list()
  for(n in n_seq){
    for(mu in mu_seq){
...
gibbs_xy <- function(truth, n_iter = 10000, burnin = 2000, y0 = 0.5, seed = 123){
  set.seed(seed)
  n = truth$n
  a = truth$a
  b = truth$b
...
sim = gibbs_xy(truth, n_iter = 10000, burnin = 2000, y0 = 0.5, seed = 11)
report_xy(sim)
```
...
res_list = lapply(sigmas, function(s) run_gr_for_sigma(sigma = s, k = 4, n = 10000, b = 1000))
